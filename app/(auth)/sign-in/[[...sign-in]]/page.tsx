		...
		<div className="min-h-screen grid grid-cols-1 lg:grid-cols-2 relative">
			<div className="h-full lg:flex flex-col items-center justify-center px-4">
				<div className="text-center space-y-4 pt-16 lg:pt-0">
					<h1 className="font-bold text-5xl tracking-tighter bg-gradient-to-b from-black to-[#001E80] dark:from-white dark:to-[#001E80] text-transparent bg-clip-text">
						Welcome Back!
					</h1>
				...
				<motion.img
					...
					height={200}
					width={200}
					className="hidden lg:block absolute bottom-14 bg-transparent left-5 rotate-60"
					animate={{
						y: [0, 50, 0],
						scale: 1,
					}}
